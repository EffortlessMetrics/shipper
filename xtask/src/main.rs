...
enum Command {
    ...
    /// Run the advisory PR-scoped ripr evidence lane — #182.
    ///
    ...
    /// Regenerate repo-scoped Shields badge endpoints.
    #[command(name = "badges")]
    Badges(ripr::BadgeArgs),

    /// Back-compat alias for `cargo xtask badges`.
    #[command(name = "repo-ripr-badge-artifacts")]
    RepoRiprBadgeArtifacts,

    /// Generate advisory RIPR changed-line review guidance.
